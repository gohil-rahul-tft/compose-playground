...
class ExpertChatService : Service() {
    ...
    companion object {
        private const val TAG = "ExpertChatService"
    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        scope.launch {
            easyWs = client.easyWebSocket(Constants.SELF_BEST_SOCKET_URL.createSocketUrl("676"))
            socketJob()
        }
            ...
            easyWs?.textChannel?.consumeEach { msg ->
                when (msg) {
                    ...
                    is SocketUpdate.Success -> {
                        ...
                        val intent = Intent(Constants.EXPERT_CHAT_ACTION)
